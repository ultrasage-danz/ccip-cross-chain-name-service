...
export class CrossChainNameServiceLookup__factory extends ContractFactory {
  ...
  override connect(
    ...
    return super.connect(runner) as CrossChainNameServiceLookup__factory;
  }

  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): CrossChainNameServiceLookupInterface {
    return new Interface(_abi) as CrossChainNameServiceLookupInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as CrossChainNameServiceLookup;
  }
}
